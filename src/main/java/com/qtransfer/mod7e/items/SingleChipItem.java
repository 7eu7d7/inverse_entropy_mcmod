...
import com.github.tbekolay.jnumeric.JNumeric;
...
public class SingleChipItem implements INBTSerializable<NBTTagCompound>{
    ...
    public void initScript(InitCallBack call_init){
        ...
        th_run=new Thread(){
            ...
            public void run() {
                init_ok=false;
                PythonInterpreter interpreter = PythonScript.createInterpreter(folder_this.toString());
                try {
